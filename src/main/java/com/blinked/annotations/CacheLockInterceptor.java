...
import com.blinked.cache.AbstractStringCacheStore;
import com.blinked.exceptions.FrequentAccessException;
import com.blinked.exceptions.ServiceException;
...
public class CacheLockInterceptor {
	...
	@Around("@annotation(com.blinked.annotations.CacheLock)")
	public Object interceptCacheLock(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		try {
			...
			if (!cacheResult) {
				throw new FrequentAccessException("Visits are too frequent, please try again later!")
