...
public class EmailVerificationService {
	...
	public void sendmail(String mailAddress, JavaMailSender javaMailSender, String otp) throws MailException, AddressException, MessagingException {
		...
		mail.setFrom("salahsayedatwa@gmail.com");
		...
		Properties props = new Properties();
		   ...
		   Session session = Session.getInstance(props, new javax.mail.Authenticator() {
		      protected PasswordAuthentication getPasswordAuthentication() {
		         return new PasswordAuthentication("salahsayedatwa@gmail.com", "ovviocmfvepvoesq");
		      }
		   });
		   Message msg = new MimeMessage(session);
		   msg.setFrom(new InternetAddress("salahsayedatwa@gmail.com", false));
