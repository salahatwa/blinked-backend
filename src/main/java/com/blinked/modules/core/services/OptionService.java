...
public interface OptionService extends CrudService<Option, Integer> {
	 ...
	 */
	@Nullable
	<T extends Enum<T>> T getEnumByPropertyOrDefault(@NonNull PropertyEnum property, @NonNull Class<T> valueType,
	 ...
	 *
	 * @return blog base url (If blog url isn't present, current machine IP address
	 *         will be default)
	 */
	@NonNull
